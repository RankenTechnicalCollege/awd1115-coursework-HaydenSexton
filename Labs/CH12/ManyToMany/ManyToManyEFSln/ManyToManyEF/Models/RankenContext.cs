    ...
    public class RankenContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Student>().HasData(
                ...
                new Student { StudentId = 2, Name = "Emily Carter", FinancialAidStatus = "Passed" },
                new Student { StudentId = 3, Name = "Michael Anderson", FinancialAidStatus = "Passed" },
                new Student { StudentId = 4, Name = "Sophia Martinez", FinancialAidStatus = "Passed" }
            );
